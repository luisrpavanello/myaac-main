        ...
        <table class="zealot-market-activity__table">
            ...
            <?php foreach ($history as $listing) {
                ...
                <tr>
                    ...
                    <td data-label="Result"><span class="zealot-market-activity__status zealot-market-activity__status--<?= $statusClass; ?>"><?= htmlspecialchars(siteText($status), ENT_QUOTES, 'UTF-8'); ?></span></td>
                    ...
                    <td data-label="Completed"><?= htmlspecialchars(siteDate('M j, Y', strtotime((string) $dateSource)), ENT_QUOTES, 'UTF-8'); ?></td>

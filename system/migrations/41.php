...
// Seed a useful default FAQ for local Zealot/MyAAC installs.
if($db->hasTable(TABLE_PREFIX . 'faq')) {
	$faqs = [
		[
			'question' => 'What is this website?',
			'answer' => 'This is the local Zealot website. You can create an account, manage characters, check highscores, houses, guilds, forum, shop and server information here.',
		],
		[
